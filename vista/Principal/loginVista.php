            ...
            <div class="col-md-8">
              <form method="post" name="login" action="<?php echo $asist->url("principal","login"); ?>" class="form-horizontal" role="form">
                <div class="form-group">
                  ...
                  <div class="col-sm-10"><input class="form-control" id="email" type="email" name="email" required></div>
                </div>
                <div class="form-group">
                  <label for="password" class="col-sm-2 control-label">Contrase&ntilde;a</label>
                  <div class="col-sm-10"><input class="form-control" id="password" type="password" name="password" required></div>
                </div>
                <div class="form-group">
